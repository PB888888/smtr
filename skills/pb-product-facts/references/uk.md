...
the United Kingdom; do not generalise from another market.

- **Currency:** GBP, written `£`
...
> the right one. Sending a United Kingdom customer to the wrong store is a common own goal —
...
| Areas served / surcharges | > **TODO(jake):** Mainland UK, and note whether Highlands, islands, Northern Ireland, Isle of Man or Channel Islands differ — they usually do, and it is a frequent question. |
...
| Statutory rights | Consumer Rights Act 2015; 14-day cooling-off period under the Consumer Contracts Regulations for distance sales. |
...
> **TODO(jake):** anything a United Kingdom customer asks that customers elsewhere do not —
